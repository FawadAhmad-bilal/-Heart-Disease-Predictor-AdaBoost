...
🔗 **[Live App]((https://fawadahmadbilal1.streamlit.app/))**
...
## Tech Stack
`Python` `Scikit-learn` `AdaBoost` `Streamlit` `UCI Dataset`
...
## Dataset
UCI Heart Disease Dataset — Cleveland Clinic Foundation (1988)
